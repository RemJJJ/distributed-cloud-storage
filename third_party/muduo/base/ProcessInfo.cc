...
Timestamp ProcessInfo::startTime() { return ProcessInfo::detail::g_startTime; }

int ProcessInfo::clockTicksPerSecond() {
    return ProcessInfo::detail::g_clockTicks;
}

int ProcessInfo::pageSize() { return ProcessInfo::detail::g_pageSize; }
